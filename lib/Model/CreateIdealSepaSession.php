...
/**
 * CreateIdealSepaSession Class Doc Comment
 *
 * @category Class
 * @package  Reepay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreateIdealSepaSession implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreateIdealSepaSession';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['spec_in'] === null) {
            $invalidProperties[] = "'spec_in' can't be null";
        }
