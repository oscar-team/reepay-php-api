...
class ChargeSearch implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'search' => 'string',
        'sort' => 'string',
        'content' => '\Swagger\Client\Model\Charge[]',
        'total_elements' => 'int',
        'total_pages' => 'int'
    ];
    ...
    public function setPage($page)
    {
        ...
        if (($page < 1)) {
            throw new \InvalidArgumentException('invalid value for $page when calling ChargeSearch., must be bigger than or equal to 1.');
        }
    ...
    public function setSize($size)
    {
        ...
        if (($size < 1)) {
            throw new \InvalidArgumentException('invalid value for $size when calling ChargeSearch., must be bigger than or equal to 1.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling ChargeSearch., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Sets content
     * @param \Swagger\Client\Model\Charge[] $content List of charges for current page
     * @return $this
     */
    ...
    public function setTotalElements($total_elements)
    {
        ...
        if (($total_elements < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_elements when calling ChargeSearch., must be bigger than or equal to 0.');
        }
    ...
    public function setTotalPages($total_pages)
    {
        ...
        if (($total_pages < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_pages when calling ChargeSearch., must be bigger than or equal to 0.');
        }
