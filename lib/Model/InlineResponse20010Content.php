 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20010Content implements ArrayAccess
{
    ...
    public function setMaxRedemptions($max_redemptions)
    {
        ...
        if (!is_null($max_redemptions) && ($max_redemptions < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_redemptions when calling InlineResponse20010Content., must be bigger than or equal to 0.');
        }
