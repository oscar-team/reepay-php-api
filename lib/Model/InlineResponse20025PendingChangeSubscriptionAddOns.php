...
/**
 * InlineResponse20025PendingChangeSubscriptionAddOns Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20025PendingChangeSubscriptionAddOns implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_25_pending_change_subscription_add_ons';
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling InlineResponse20025PendingChangeSubscriptionAddOns., must be bigger than or equal to 1.');
        }
