...
class CreateSubscriptionSession implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'allowed_ip' => 'string',
        'prepare_subscription' => '\Reepay\Model\CreatePreparedSubscription',
        'show_terms' => 'bool',
     ...
     *
     * @return \Reepay\Model\CreatePreparedSubscription
     */
     ...
     *
     * @param \Reepay\Model\CreatePreparedSubscription $prepare_subscription prepare_subscription
     *
     * @return $this
     */
     ...
     * Sets show_terms
     *
     * @param bool $show_terms Toggle whether terms should be shown and acceptance required. If not defined the default is to show terms if no payment method has previously been added. Set this option to false if terms have already been showed in own system.
     *
     * @return $this
     */
     ...
     *
     * @param bool $show_subscription_details Toggle whether to show subscription details. Default is to show details. Set this option to false if subscription details have already been shown in own system.
     *
     * @return $this
     */
