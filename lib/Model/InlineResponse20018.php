...
class InlineResponse20018 implements ArrayAccess
{
    ...
    public function setPage($page)
    {
        ...
        if (($page < 1)) {
            throw new \InvalidArgumentException('invalid value for $page when calling InlineResponse20018., must be bigger than or equal to 1.');
        }
    ...
    public function setSize($size)
    {
        ...
        if (($size < 1)) {
            throw new \InvalidArgumentException('invalid value for $size when calling InlineResponse20018., must be bigger than or equal to 1.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling InlineResponse20018., must be bigger than or equal to 0.');
        }
