...
class SupersedeSubscriptionPlan implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = $this->getSupersedeModeAllowableValues();
    ...
    public function setSetupFee($setup_fee)
    {
        ...
        if (!is_null($setup_fee) && ($setup_fee < 0)) {
            throw new \InvalidArgumentException('invalid value for $setup_fee when calling SupersedeSubscriptionPlan., must be bigger than or equal to 0.');
        }
