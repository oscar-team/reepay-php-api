...
/**
 * V1subscriptionSubscriptionDiscounts Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V1subscriptionSubscriptionDiscounts implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1subscription_subscription_discounts';
    ...
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && ($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling V1subscriptionSubscriptionDiscounts., must be bigger than or equal to 1.');
        }
    ...
    public function setPercentage($percentage)
    {
        ...
        if (!is_null($percentage) && ($percentage > 100)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling V1subscriptionSubscriptionDiscounts., must be smaller than or equal to 100.');
        }
        if (!is_null($percentage) && ($percentage < 1)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling V1subscriptionSubscriptionDiscounts., must be bigger than or equal to 1.');
        }
    ...
    public function setFixedCount($fixed_count)
    {
        ...
        if (!is_null($fixed_count) && ($fixed_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $fixed_count when calling V1subscriptionSubscriptionDiscounts., must be bigger than or equal to 1.');
        }
    ...
    public function setFixedPeriod($fixed_period)
    {
        ...
        if (!is_null($fixed_period) && ($fixed_period < 1)) {
            throw new \InvalidArgumentException('invalid value for $fixed_period when calling V1subscriptionSubscriptionDiscounts., must be bigger than or equal to 1.');
        }
