...
/**
 * InlineResponse2008Organisation Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2008Organisation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_8_organisation';
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["signup", "live"];
        if (!in_array($this->container['state'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'state', must be one of 'signup', 'live'.";
        }
