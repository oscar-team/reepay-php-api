...
class InlineResponse20011 implements ArrayAccess
{
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling InlineResponse20011., must be bigger than or equal to 0.');
        }
    ...
    public function setPendingAmount($pending_amount)
    {
        ...
        if (($pending_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $pending_amount when calling InlineResponse20011., must be bigger than or equal to 0.');
        }
