...
class CustomerSearch implements ArrayAccess
{
    ...
    public function setPage($page)
    {
        ...
        if (($page < 1)) {
            throw new \InvalidArgumentException('invalid value for $page when calling CustomerSearch., must be bigger than or equal to 1.');
        }
    ...
    public function setSize($size)
    {
        ...
        if (($size < 1)) {
            throw new \InvalidArgumentException('invalid value for $size when calling CustomerSearch., must be bigger than or equal to 1.');
        }
    ...
    public function setCount($count)
    {
        ...
        if (($count < 0)) {
            throw new \InvalidArgumentException('invalid value for $count when calling CustomerSearch., must be bigger than or equal to 0.');
        }
    ...
    public function setTotalElements($total_elements)
    {
        ...
        if (($total_elements < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_elements when calling CustomerSearch., must be bigger than or equal to 0.');
        }
    ...
    public function setTotalPages($total_pages)
    {
        ...
        if (($total_pages < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_pages when calling CustomerSearch., must be bigger than or equal to 0.');
        }
