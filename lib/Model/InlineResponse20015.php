...
class InlineResponse20015 implements ArrayAccess
{
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling InlineResponse20015., must be bigger than or equal to 0.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if (($number < 1)) {
            throw new \InvalidArgumentException('invalid value for $number when calling InlineResponse20015., must be bigger than or equal to 1.');
        }
    ...
    public function setDiscountAmount($discount_amount)
    {
        ...
        if (($discount_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $discount_amount when calling InlineResponse20015., must be bigger than or equal to 0.');
        }
    ...
    public function setOrgAmount($org_amount)
    {
        ...
        if (($org_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $org_amount when calling InlineResponse20015., must be bigger than or equal to 0.');
        }
