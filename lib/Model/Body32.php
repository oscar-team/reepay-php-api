...
class Body32 implements ArrayAccess
{
    ...
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && ($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling Body32., must be bigger than or equal to 0.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling Body32., must be bigger than or equal to 1.');
        }
    ...
    public function setPlanVersion($plan_version)
    {
        ...
        if (!is_null($plan_version) && ($plan_version < 1)) {
            throw new \InvalidArgumentException('invalid value for $plan_version when calling Body32., must be bigger than or equal to 1.');
        }
    ...
    public function setGraceDuration($grace_duration)
    {
        ...
        if (!is_null($grace_duration) && ($grace_duration < 0)) {
            throw new \InvalidArgumentException('invalid value for $grace_duration when calling Body32., must be bigger than or equal to 0.');
        }
