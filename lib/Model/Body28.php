...
class Body28 implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["no_sub_update", "scheduled_sub_update", "instant_sub_update"];
        if (!in_array($this->container['supersede_mode'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'supersede_mode', must be one of 'no_sub_update', 'scheduled_sub_update', 'instant_sub_update'.";
        }
    ...
    public function setVat($vat)
    {
        ...
        if (!is_null($vat) && ($vat > 1)) {
            throw new \InvalidArgumentException('invalid value for $vat when calling Body28., must be smaller than or equal to 1.');
        }
        if (!is_null($vat) && ($vat < 0)) {
            throw new \InvalidArgumentException('invalid value for $vat when calling Body28., must be bigger than or equal to 0.');
        }
    ...
    public function setRenewalReminderEmailDays($renewal_reminder_email_days)
    {
        ...
        if (!is_null($renewal_reminder_email_days) && ($renewal_reminder_email_days < 1)) {
            throw new \InvalidArgumentException('invalid value for $renewal_reminder_email_days when calling Body28., must be bigger than or equal to 1.');
        }
    ...
    public function setTrialReminderEmailDays($trial_reminder_email_days)
    {
        ...
        if (!is_null($trial_reminder_email_days) && ($trial_reminder_email_days < 1)) {
            throw new \InvalidArgumentException('invalid value for $trial_reminder_email_days when calling Body28., must be bigger than or equal to 1.');
        }
    ...
    public function setFixedCount($fixed_count)
    {
        ...
        if (!is_null($fixed_count) && ($fixed_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $fixed_count when calling Body28., must be bigger than or equal to 1.');
        }
    ...
    public function setFixedLifeTimeLength($fixed_life_time_length)
    {
        ...
        if (!is_null($fixed_life_time_length) && ($fixed_life_time_length < 1)) {
            throw new \InvalidArgumentException('invalid value for $fixed_life_time_length when calling Body28., must be bigger than or equal to 1.');
        }
    ...
    public function setTrialIntervalLength($trial_interval_length)
    {
        ...
        if (!is_null($trial_interval_length) && ($trial_interval_length < 1)) {
            throw new \InvalidArgumentException('invalid value for $trial_interval_length when calling Body28., must be bigger than or equal to 1.');
        }
    ...
    public function setIntervalLength($interval_length)
    {
        ...
        if (($interval_length < 1)) {
            throw new \InvalidArgumentException('invalid value for $interval_length when calling Body28., must be bigger than or equal to 1.');
        }
    ...
    public function setScheduleFixedDay($schedule_fixed_day)
    {
        ...
        if (!is_null($schedule_fixed_day) && ($schedule_fixed_day > 28)) {
            throw new \InvalidArgumentException('invalid value for $schedule_fixed_day when calling Body28., must be smaller than or equal to 28.');
        }
        if (!is_null($schedule_fixed_day) && ($schedule_fixed_day < 1)) {
            throw new \InvalidArgumentException('invalid value for $schedule_fixed_day when calling Body28., must be bigger than or equal to 1.');
        }
    ...
    public function setBaseMonth($base_month)
    {
        ...
        if (!is_null($base_month) && ($base_month > 12)) {
            throw new \InvalidArgumentException('invalid value for $base_month when calling Body28., must be smaller than or equal to 12.');
        }
        if (!is_null($base_month) && ($base_month < 1)) {
            throw new \InvalidArgumentException('invalid value for $base_month when calling Body28., must be bigger than or equal to 1.');
        }
    ...
    public function setNoticePeriods($notice_periods)
    {
        ...
        if (!is_null($notice_periods) && ($notice_periods < 0)) {
            throw new \InvalidArgumentException('invalid value for $notice_periods when calling Body28., must be bigger than or equal to 0.');
        }
    ...
    public function setFixationPeriods($fixation_periods)
    {
        ...
        if (!is_null($fixation_periods) && ($fixation_periods < 0)) {
            throw new \InvalidArgumentException('invalid value for $fixation_periods when calling Body28., must be bigger than or equal to 0.');
        }
    ...
    public function setSupersedeMode($supersede_mode)
    {
        ...
        if (!is_null($supersede_mode) && (!in_array($supersede_mode, $allowed_values))) {
