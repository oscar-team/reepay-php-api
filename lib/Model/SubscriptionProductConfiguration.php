...
/**
 * SubscriptionProductConfiguration Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SubscriptionProductConfiguration implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SubscriptionProductConfiguration';
    ...
    protected static $swaggerTypes = [
        'amount' => 'int',
        'quantity' => 'int',
        'discounts' => '\Reepay\Model\Discount[]',
        'add_ons' => '\Reepay\Model\AddOn[]',
     ...
     * Sets discounts
     *
     * @param \Reepay\Model\Discount[] $discounts Discounts to attach to subscription
     *
     * @return $this
     */
     ...
     * Sets add_ons
     *
     * @param \Reepay\Model\AddOn[] $add_ons Add-ons to attach to subscription. The same add-on can only be attached to subscription once unless unique handles are supplied for the subscription add-on.
     *
     * @return $this
     */
     ...
     *
     * @param bool $can_configure_plan_quantity Indicates whether customers can modify the quantity of subscription plans to purchase.
     *
     * @return $this
     */
