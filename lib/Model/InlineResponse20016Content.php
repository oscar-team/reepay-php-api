...
/**
 * InlineResponse20016Content Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20016Content implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_16_content';
    ...
    public function setAmount($amount)
    {
        ...
        if (!is_null($amount) && ($amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling InlineResponse20016Content., must be bigger than or equal to 0.');
        }
    ...
    public function setPercentage($percentage)
    {
        ...
        if (!is_null($percentage) && ($percentage > 100)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling InlineResponse20016Content., must be smaller than or equal to 100.');
        }
        if (!is_null($percentage) && ($percentage < 1)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling InlineResponse20016Content., must be bigger than or equal to 1.');
        }
    ...
    public function setFixedCount($fixed_count)
    {
        ...
        if (!is_null($fixed_count) && ($fixed_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $fixed_count when calling InlineResponse20016Content., must be bigger than or equal to 1.');
        }
    ...
    public function setFixedPeriod($fixed_period)
    {
        ...
        if (!is_null($fixed_period) && ($fixed_period < 1)) {
            throw new \InvalidArgumentException('invalid value for $fixed_period when calling InlineResponse20016Content., must be bigger than or equal to 1.');
        }
