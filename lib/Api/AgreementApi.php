...
class AgreementApi
{
     ...
     * @param \Reepay\Model\CreateCardGatewayAgreement $body  (optional)
     * @throws \Reepay\ApiException on non-2xx response
     * @return array of \Reepay\Model\CardGatewayAgreement, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCardGatewayAgreementWithHttpInfo($body = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Reepay\Model\CardGatewayAgreement', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Reepay\Model\CardGatewayAgreement', $e->getResponseHeaders());
