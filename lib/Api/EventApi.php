...
class EventApi
{
    ...
    public function getEventWithHttpInfo($id)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Reepay\Model\Event', $httpHeader), $statusCode, $httpHeader];
    ...
    public function getEventsWithHttpInfo($page = '1', $size = '20', $customer = null, $subscription = null, $invoice = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Reepay\Model\EventList', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
